...
const NETLIFY_FUNCTION_URL =
  "glistening-parfait-60dfa8.netlify.app";
...
form.addEventListener("submit", async (event) => {
  ...
  try {
    const response = await fetch("glistening-parfait-60dfa8.netlify.app", {
      method: "POST",
      headers: {
...
/*function sendForm(event) {
    ...
    fetch(form.action, {
        ...
        .catch(() => {
            formMessage.textContent = "There was an error, try again later!!";
        });
