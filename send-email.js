...
exports.handler = async (event) => {
  ...
  try {
    ...
    const Task."christalee.harper@gmail.com" = process.env."ask.christalee.harper@gmail.com";     // example: ask.christalee.harper@gmail.com
    const "ask.christalee.harper@gmail.com" = process.env."ask.christalee.harper@gmail.com"; // must be allowed in Elastic Email ask.christalee.harper@gmail.com

    if (!"ask.christalee.harper@gmail.com" || !F "ask.christalee.harper@gmail.com") {
